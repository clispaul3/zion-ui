...
const kSeekToReq = 7;
const KOpenSoundReq = 8;
const kContinueReq = 9;
const kPauseReq = 10;
const kSpeedReq = 11;
const kGetCurEsCountReq = 13;
const KDecodeReq = 14;
const kGetAudioCurEsCountReq = 15;
const KClearDecode = 16; // 清空解码器缓存
//Decoder response.
...
const kSeekToRsp = 10;
const kDowntoFile = 11;
const kSpeedRsp = 12;
const kGetCurEsCountRsp = 13;
const KDecodeRsp = 14;
const kGetAudioCurEsCountRsp = 15;
