...
// 	["interface", "https://www.yuque.com/zhangyangbin-9bbif/sa0po2/gr33o7"],
...
export const RadioDemo = () => {
  ...
  const Tpl1 = Table({
    ...
    dataSource: [
      ...
      { key: "allowCancel", explain: "选中后不可取消", type: "boolean", requisite: "否", default: "false" },
  ...
  const Tpl2 = Table({
    ...
    dataSource: [
      ...
      { key: "init", explain: "下拉框初始化", type: "Promise<IDataSourceItem[]>", requisite: "否", default: "" },
    ]
  }, true)
  const Tpl3 = Table({
    columns: [
  ...
  const Tpl4 = Table({
    ...
    rowKey: "key",
    dataSource: [
      { key: "value", explain: "单选框的值", type: "string[] | []", requisite: "否", defalut: "[]" },
      { key: "checked", explain: "当前单选框是否选中", type: "boolean", requisite: "否", default: "" },
